  ...
  return (
    <Animated.View style={styles.container}>
      ...
      <Animated.View style={styles.punchLine}>
        <Text style={{fontWeight:'bold', color: 'white', fontSize: hp(8)}}>Foody</Text>
        <Text style={{fontWeight:'medium', color: 'white', fontSize: hp(2.5)}}>Food is always right</Text>
      </Animated.View>
    </Animated.View>
  );
}
...
const styles = StyleSheet.create({
  container: {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    backgroundColor: '#fbbf24', // amber-500 in hex
  },
